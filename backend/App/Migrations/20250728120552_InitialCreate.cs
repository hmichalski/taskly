        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Freelancers_FreelancerId",
                        column: x => x.FreelancerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserServiceLikes", x => new { x.UserId, x.ServiceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserServiceLikes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartServices", x => new { x.ShoppingCartId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_ShoppingCartServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCartServices_ShoppingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_FreelancerId",
                table: "Addresses",
                column: "FreelancerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartServices_ServiceId",
